...
function Sr(e, t, n, r, l) {
  ...
  if (((o = 0), (r = r === "" ? "." : r + ":"), $o(e)))
    ...
    for (e = s.call(e), u = 0; !(i = e.next()).done; )
      (i = i.value), (s = r + kl(i, u++)), (o += Sr(i, t, n, s, l));
  else if (i === "object")
    throw (
      ((t = String(e)),
      Error(
...
D.StrictMode = cc;
D.Suspense = hc;
D.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = kc;
D.act = es;
 ...
 */ (function (e) {
  ...
  function r(_) {
    ...
    if (T !== z) {
      _[0] = T;
      e: for (var K = 0, J = _.length, nr = J >>> 1; K < nr; ) {
        var gt = 2 * (K + 1) - 1,
          Sl = _[gt],
          xt = gt + 1,
          rr = _[xt];
        if (0 > l(Sl, T))
          xt < J && 0 > l(rr, Sl)
            ? ((_[K] = rr), (_[xt] = T), (K = xt))
            : ((_[K] = Sl), (_[gt] = T), (K = gt));
        else if (xt < J && 0 > l(rr, T)) (_[K] = rr), (_[xt] = T), (K = xt);
        else break e;
      }
    }
    return z;
  ...
  function y(_) {
    if (((k = !1), d(_), !S))
      if (n(s) !== null) (S = !0), xl(w);
      else {
        var z = n(c);
        z !== null && wl(y, z.startTime - _);
      }
  }
  function w(_, z) {
    (S = !1), k && ((k = !1), f(j), (j = -1)), (x = !0);
    var T = p;
    try {
      for (
        d(z), h = n(s);
        h !== null && (!(h.expirationTime > z) || (_ && !ve()));
      ...
      if (h !== null) var nr = !0;
        ...
        var gt = n(c);
        gt !== null && wl(y, gt.startTime - z), (nr = !1);
      }
      return nr;
    } finally {
      (h = null), (p = T), (x = !1);
      ...
      return (
        ...
        T > K
          ? ((_.sortIndex = T),
            ...
            n(s) === null &&
              _ === n(c) &&
              (k ? (f(j), (j = -1)) : (k = !0), wl(y, T - K)))
          : ((_.sortIndex = J), t(s, _), S || x || ((S = !0), xl(w))),
        _
      );
    }),
...
function Bc(e, t, n, r, l, i, o, u, s) {
  (_n = !1), (Rr = null), Vc.apply(Uc, arguments);
}
...
var Ns = we.unstable_scheduleCallback,
  ...
  Ji = we.unstable_ImmediatePriority,
...
function rf(e, t, n, r, l) {
  switch (t) {
    ...
    case "gotpointercapture":
      return (
        (i = l.pointerId), Mn.set(i, hn(Mn.get(i) || null, e, t, n, r, l)), !0
      );
  }
  return !1;
}
...
var Ar = null;
function di(e, t, n, r) {
  if (((Ar = null), (e = Zi(r)), (e = kt(e)), e !== null))
...
var an = {
  ...
  il = W({}, bn, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== yn &&
            (yn && e.type === "mousemove"
              ? ((jl = e.screenX - yn.screenX), (zl = e.screenY - yn.screenY))
              : (zl = jl = 0),
            (yn = e)),
          jl);
    },
  ...
  qo = ke(il),
  af = W({}, il, { dataTransfer: 0 }),
  cf = ke(af),
  ff = W({}, bn, { relatedTarget: 0 }),
  Tl = ke(ff),
  df = W({}, an, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  pf = ke(df),
  mf = W({}, an, {
...
var Sf = W({}, bn, {
  ...
  Nf = ke(Cf),
  _f = W({}, an, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Pf = ke(_f),
  jf = W({}, il, {
    deltaX: function (e) {
...
var Lf = Ke && "TextEvent" in window && !Pn,
  $s = Ke && (!lo || (Pn && 8 < Pn && 11 >= Pn)),
  tu = " ",
  nu = !1;
function Ms(e, t) {
  switch (e) {
...
function Ff(e, t) {
  if (Mt)
    return e === "compositionend" || (!lo && Ms(e, t))
      ? ((e = Os()), (Cr = to = nt = null), (Mt = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function iu() {
  jn && (jn.detachEvent("onpropertychange", Bs), (Vn = jn = null));
}
function Bs(e) {
  if (e.propertyName === "value" && ol(Vn)) {
    var t = [];
    Vs(t, Vn, e, Zi(e)), Ss(If, t);
  }
}
function $f(e, t, n) {
  e === "focusin"
    ? (iu(), (jn = t), (Vn = n), jn.attachEvent("onpropertychange", Bs))
    : e === "focusout" && iu();
}
function Mf(e) {
...
function Bn(e) {
  if (!e[pr]) {
    ...
    t === null || t[pr] || ((t[pr] = !0), Ol("selectionchange", !1, t));
  }
}
function qs(e, t, n, r) {
  switch (Is(t)) {
  ...
  Ss(function () {
    ...
    e: {
      ...
      if (p !== void 0) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              y !== null &&
              ((d = y),
              f !== null && ((y = On(a, f)), y != null && k.push(Hn(a, y, d)))),
            F)
          )
            break;
          a = a.return;
        ...
        0 < k.length &&
          ((p = new x(p, S, null, n, m)), h.push({ event: p, listeners: k }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (k = x, f = S, a = 0, d = k; d; d = It(d)) a++;
...
function V(e) {
  0 > Bt || ((e.current = wi[Bt]), (wi[Bt] = null), Bt--);
}
function M(e, t) {
  Bt++, (wi[Bt] = e.current), (e.current = t);
}
var pt = {},
  oe = ht(pt),
  pe = ht(!1),
...
function vt() {
  if (!Al && Be !== null) {
    ...
    try {
      ...
      throw (Be !== null && (Be = Be.slice(e + 1)), Ns(Ji, vt), l);
    } finally {
      (I = t), (Al = !1);
    }
  }
      ...
      return (
        (t =
          t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
            ...
            : t),
        t !== null
          ? ((e.stateNode = t), (xe = e), (ge = ut(t.firstChild)), !0)
          : !1
      );
    case 6:
      return (
...
function hr(e) {
  ...
  } else ge = xe ? ut(e.stateNode.nextSibling) : null;
  return !0;
}
function ra() {
...
function la(e) {
  ...
  function m(f, a, d, y, w) {
    return a === null || a.tag !== 7
      ? ((a = _t(d, f.mode, y, w)), (a.return = f), a)
      : ((a = l(a, d)), (a.return = f), a);
  }
  function h(f, a, d) {
  ...
  function p(f, a, d, y) {
    ...
    if ((typeof d == "string" && d !== "") || typeof d == "number")
      return w !== null ? null : u(f, a, "" + d, y);
    if (typeof d == "object" && d !== null) {
      switch (d.$$typeof) {
        case ir:
          return d.key === w ? s(f, a, d, y) : null;
        case Ot:
          return d.key === w ? c(f, a, d, y) : null;
        case qe:
          return (w = d._init), p(f, a, w(d._payload), y);
      }
      if (kn(d) || pn(d)) return w !== null ? null : m(f, a, d, y, null);
      vr(f, d);
    }
    return null;
  }
  function x(f, a, d, y, w) {
    if ((typeof y == "string" && y !== "") || typeof y == "number")
      return (f = f.get(d) || null), u(a, f, "" + y, w);
    if (typeof y == "object" && y !== null) {
      switch (y.$$typeof) {
        case ir:
          return (f = f.get(y.key === null ? d : y.key) || null), s(a, f, y, w);
        case Ot:
          return (f = f.get(y.key === null ? d : y.key) || null), c(a, f, y, w);
        case qe:
          var E = y._init;
          return x(f, a, d, E(y._payload), w);
      }
      if (kn(y) || pn(y)) return (f = f.get(d) || null), m(a, f, y, w, null);
      vr(a, y);
    }
    return null;
  }
  function S(f, a, d, y) {
    for (
      var w = null, E = null, N = a, j = (a = 0), O = null;
      N !== null && j < d.length;
      j++
    ) {
    ...
    if (j === d.length) return n(f, N), U && wt(f, j), w;
    if (N === null) {
      for (; j < d.length; j++)
        (N = h(f, d[j], y)),
          N !== null &&
            ((a = i(N, a, j)), E === null ? (w = N) : (E.sibling = N), (E = N));
      return U && wt(f, j), w;
    }
  ...
  function k(f, a, d, y) {
    ...
    for (
      var E = (w = null), N = a, j = (a = 0), O = null, L = d.next();
      N !== null && !L.done;
      j++, L = d.next()
    ) {
      N.index > j ? ((O = N), (N = null)) : (O = N.sibling);
      var ve = p(f, N, L.value, y);
      if (ve === null) {
        N === null && (N = O);
        break;
      }
      e && N && ve.alternate === null && t(f, N),
        (a = i(ve, a, j)),
        E === null ? (w = ve) : (E.sibling = ve),
        (E = ve),
        (N = O);
    }
    if (L.done) return n(f, N), U && wt(f, j), w;
    if (N === null) {
      for (; !L.done; j++, L = d.next())
        (L = h(f, L.value, y)),
          L !== null &&
            ((a = i(L, a, j)), E === null ? (w = L) : (E.sibling = L), (E = L));
      return U && wt(f, j), w;
    }
        ...
        e: {
          ...
          switch (((p = t), (x = n), k.tag)) {
            ...
            case 0:
              if (
                ((S = k.payload),
                (p = typeof S == "function" ? S.call(x, h, p) : S),
                p == null)
              )
                break e;
              h = W({}, h, p);
...
function ho(e, t) {
  switch ((M(Kn, t), M(Qn, e), M(Ve, tr), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function Bl(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    l = e;
    do (i = l.lane), (H.lanes |= i), (Tt |= i), (l = l.next);
    while (l !== e);
...
function Ea(e, t, n) {
  return zt & 21
    ? (Ie(n, t) || ((n = js()), (H.lanes |= n), (Tt |= n), (e.baseState = !0)),
      t)
...
function id(e, t, n) {
  ...
  if (Na(e)) _a(t, l);
    ...
    (n = oa(e, t, l, r)),
      n !== null && ((l = se()), Re(n, e, r, l), Pa(n, t, r));
  }
}
function Na(e) {
  var t = e.alternate;
  ...
  od = {
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Gn(9, da.bind(null, r, i, n, t), void 0, null),
        n
      );
    },
    useId: function () {
  ...
  return (
    ...
    e !== null && !de
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ge(e, t, l))
      : (U && n && oo(t), (t.flags |= 1), ue(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !de
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ge(e, t, l))
      : (U && r && oo(t), (t.flags |= 1), ue(e, t, n, l), t.child)
  );
}
function Lu(e, t, n, r, l) {
  ...
  if ((qt(t, l), t.stateNode === null))
    ...
    u !== h || p !== S || pe.current || be
      ? (typeof x == "function" && (Ci(t, n, x, r), (S = t.memoizedState)),
        (c = be || Cu(t, n, c, r, p, S, s) || !1)
          ? (m ||
...
function ji(e, t, n, r, l, i) {
  Fa(e, t);
  var o = (t.flags & 128) !== 0;
  if (!r && !o) return l && vu(t, n, !1), Ge(e, t, i);
...
function Du(e, t, n, r, l) {
  return nn(), so(l), (t.flags |= 256), ue(e, t, n, r), t.child;
}
...
function fd(e, t, n, r, l, i, o) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = Wl(Error(g(422)))), yr(e, t, o, r))
      : t.memoizedState !== null
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (i = Error(g(419))), (r = Wl(i, r, void 0)), yr(e, t, o, r);
  }
  if (((u = (o & e.childLanes) !== 0), de || u)) {
    ...
    return zo(), (r = Wl(Error(g(421)))), yr(e, t, o, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
  ...
  switch ((uo(t), t.tag)) {
    ...
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = Ct(Ve.current)), hr(t))) {
          (r = t.stateNode), (n = t.type);
          var i = t.memoizedProps;
          switch (((r[Me] = t), (r[Wn] = i), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
    ...
    case 6:
      if (e && t.stateNode != null) Aa(e, t, e.memoizedProps, r);
        ...
        if (((n = Ct(Kn.current)), Ct(Ve.current), hr(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Me] = t),
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || B.current & 1 ? Z === 0 && (Z = 3) : zo())),
          t.updateQueue !== null && (t.flags |= 4),
          le(t),
          null);
    case 4:
      return (
        ln(), Li(e, t), e === null && Bn(t.stateNode.containerInfo), le(t), null
      );
    case 10:
    ...
    case 17:
      return me(t.type) && Br(), le(t), null;
    case 19:
      if ((V(B), (i = t.memoizedState), i === null)) return le(t), null;
...
function vd(e, t) {
  ...
  for (vi = { focusedElem: e, selectionRange: n }, Mr = !1, C = t; C !== null; )
...
function Va(e) {
  ...
  t !== null && ((e.alternate = null), Va(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Me], delete t[Wn], delete t[xi], delete t[qf], delete t[bf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
  ...
  switch (e.tag) {
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((ie = (c = ie) || m), ze(t, e), (ie = c)) : ze(t, e),
        Oe(e),
        r & 8192)
      ) {
        if (
...
function Wa(e, t, n) {
  for (var r = (e.mode & 1) !== 0; C !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && i !== null ? ((i.return = l), (C = i)) : $u(e);
  }
}
function $u(e) {
  for (; C !== null; ) {
...
function Re(e, t, n, r) {
  if (50 < Fn) throw ((Fn = 0), ($i = null), Error(g(185)));
  qn(e, n, r),
    (!(R & 2) || e !== b) &&
      (e === b && (!(R & 2) && (pl |= n), Z === 4 && tt(e, te)),
      he(e, r),
      n === 1 && R === 0 && !(t.mode & 1) && ((un = Y() + 500), al && vt()));
}
function he(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && Xo(n), t === 1))
      e.tag === 0 ? ed(Vu.bind(null, e)) : ea(Vu.bind(null, e)),
        Zf(function () {
          !(R & 6) && vt();
        }),
        (n = null);
...
function Qa(e, t) {
  if (((Tr = -1), (Lr = 0), R & 6)) throw Error(g(327));
  var n = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || t) t = tl(e, r);
    ...
    R |= 2;
    var i = Ya();
    (b !== e || te !== t) && ((Ue = null), (un = Y() + 500), Nt(e, t));
    do
      try {
        Sd();
        break;
  ...
  if (t !== 0) {
    if (
      (t === 2 && ((l = ci(e)), l !== 0 && ((r = l), (t = Mi(e, l)))), t === 1)
    )
      throw ((n = Zn), Nt(e, 0), tt(e, r), he(e, Y()), n);
    if (t === 6) tt(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (tt(e, r), (r & 130023424) === r && ((t = _o + 500 - Y()), 10 < t))
          ) {
            if ($r(e, 0) !== 0) break;
            ...
            e.timeoutHandle = gi(St.bind(null, e, fe, Ue), t);
            break;
          }
          St(e, fe, Ue);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = gi(St.bind(null, e, fe, Ue), r);
            break;
          }
          St(e, fe, Ue);
          break;
  ...
  return he(e, Y()), e.callbackNode === n ? Qa.bind(null, e) : null;
}
function Mi(e, t) {
  var n = Dn;
  return (
...
function Vu(e) {
  ...
  if (n === 1) throw ((n = Zn), Nt(e, 0), tt(e, t), he(e, Y()), n);
...
function tl(e, t) {
  ...
  while (!0);
  if ((co(), (R = n), (qr.current = r), X !== null)) throw Error(g(261));
...
function St(e, t, n) {
  var r = I,
    l = _e.transition;
  try {
    (_e.transition = null), (I = 1), kd(e, t, n, r);
  } finally {
    (_e.transition = l), (I = r);
  }
  return null;
...
function kd(e, t, n, r) {
  ...
  if (br) throw ((br = !1), (e = Oi), (Oi = null), e);
  return (
    el & 1 && e.tag !== 0 && bt(),
    (i = e.pendingLanes),
  ...
  if (rt !== null) {
    ...
    try {
      if (((_e.transition = null), (I = 16 > e ? 16 : e), rt === null))
        ...
        if (((e = rt), (rt = null), (el = 0), R & 6)) throw Error(g(331));
        var l = R;
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            Ni(t, r, e, n),
            (t = ji(null, t, r, !0, i, n)))
          : ((t.tag = 0), U && i && oo(t), ue(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
      ...
      e: {
        ...
        if (((r = o.element), i.isDehydrated))
          if (
            ...
            (l = on(Error(g(423)), t)), (t = Du(e, t, r, n, l));
            break e;
          } else if (r !== l) {
            (l = on(Error(g(424)), t)), (t = Du(e, t, r, n, l));
            break e;
          } else
            for (
...
function Dr(e, t, n, r, l, i) {
  ...
  if (((r = e), typeof e == "function")) To(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Gl:
        return (
          (e = Ne(12, n, t, l | 2)), (e.elementType = Gl), (e.lanes = i), e
        );
      case Zl:
        return (e = Ne(13, n, t, l)), (e.elementType = Zl), (e.lanes = i), e;
      case Jl:
        return (e = Ne(19, n, t, l)), (e.elementType = Jl), (e.lanes = i), e;
      case ss:
        return ml(n, l, i, t);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (qi(t, n | 1), he(t, Y()), !(R & 6) && ((un = Y() + 500), vt()));
      }
      break;
    case 13:
      Lt(function () {
...
xs = Po;
ws = Lt;
var Dd = { usingClientEntryPoint: !1, Events: [er, Ut, sl, ys, gs, Po] },
  wn = {
  ...
  Fd = {
    ...
    findFiberByHostInstance: wn.findFiberByHostInstance || Td,
...
const Id = {
    title: "高雄榮民總醫院",
    title_en: "Kaohsiung Veterans General Hospital",
    bookAppointment: "預約施打",
    languageSwitch: "繁體中文",
    smartVaxCabinet: "RFID 雲端疫苗智控櫃",
    smartVaxCabinetEn: "SmartVax Cloud Cabinet",
  },
  Od = { inventory: "疫苗庫存量總覽", search: "疫苗庫存量查詢" },
  $d = {
    placeholder: "搜尋疫苗...",
    button: "搜尋",
    advancedSearch: "進階搜尋",
  ...
  Md = { subsidized: "公費", selfPay: "自費", healthInsurance: "健保" },
  Ad = {
    hib: "b型嗜血桿菌",
    meningococcal: "流行性腦脊髓膜炎",
    pneumococcal: "肺炎鏈球菌",
    tetanusToxoid: "破傷風類毒素",
    diphtheria: "白喉",
    tetanus: "破傷風",
    pertussis: "百日咳",
    japaneseEncephalitis: "日本腦炎",
    influenza: "流感疫苗",
    hepatitisB: "B型肝炎",
    hepatitisA: "A型肝炎",
    measles: "麻疹",
  ...
  Hd = "載入中...",
  Wd = {
    hospital: "高雄榮民總醫院 - RFID 雲端疫苗智控櫃管理系統",
  ...
  Kd = {
    ...
    smartVaxCabinet: "RFID Cloud Vaccine Smart Cabinet",
    smartVaxCabinetEn: "",
  },
  Yd = {
    inventory: "Vaccine Inventory Overview",
    search: "Vaccine Inventory Search",
  },
  Xd = {
  ...
  qd = "No data available",
  bd = "Displayed vaccine inventory is for reference only",
  ep = "Loading...",
  tp = {
    hospital:
      "Kaohsiung Veterans General Hospital - RFID Cloud Vaccine Smart Cabinet Management System",
    copyright: "© 2026 All Rights Reserved",
  },
  np = {
    header: Kd,
  ...
  lc = $.createContext(void 0),
  rp = { "zh-TW": Qd, en: np },
  lp = ({ children: e }) => {
    const [t, n] = $.useState("zh-TW"),
      r = $.useCallback((i) => {
        n(i), localStorage.setItem("language", i);
      }, []),
      l = { language: t, translations: rp[t], switchLanguage: r };
    return v.jsx(lc.Provider, { value: l, children: e });
  },
  fn = () => {
    const e = $.useContext(lc);
    if (!e) throw new Error("useLanguage must be used within LanguageProvider");
    return e;
  },
  ic = $.createContext(void 0),
  ip = { small: 1, medium: 1.2, large: 1.5 },
  op = ({ children: e }) => {
    const [t, n] = $.useState("small"),
      r = $.useCallback((o) => {
        n(o), localStorage.setItem("fontSize", o);
      }, []),
      l = $.useCallback(() => ip[t], [t]),
      i = { fontSize: t, setFontSize: r, getScaleFactor: l };
    return v.jsx(ic.Provider, { value: i, children: e });
  },
  Rt = () => {
    const e = $.useContext(ic);
    if (!e) throw new Error("useFontSize must be used within FontSizeProvider");
    return e;
  },
  up = {
    small: {
  ...
  P = (e, t) => up[e][t],
  sp = () => {
    const { translations: e, language: t, switchLanguage: n } = fn(),
      { fontSize: r } = Rt();
    return v.jsx("header", {
      className: "bg-white py-4 sm:py-6 lg:py-8",
      children: v.jsxs("div", {
        className: "lg:pl-8 mx-auto",
        children: [
          v.jsxs("div", {
            className:
              "lg:hidden space-y-4 flex flex-col justify-center items-start w-full",
            children: [
              v.jsx("div", {
                className:
                  "flex flex-col sm:items-center sm:justify-between gap-2 px-4 sm:px-6 w-full sm:flex-row",
                children: v.jsxs("div", {
                  className: "flex items-center gap-2 sm:gap-3 min-w-0 py-2",
                  children: [
                    v.jsx("img", {
                      src: "/logo.png",
                      alt: "Logo",
                    ...
                    v.jsxs("div", {
                      ...
                      children: [
                        v.jsx("div", {
                          className: `${P(r, "lg")} sm:${P(r, "xl")}`,
                          children: e.header.title,
                        }),
                        v.jsx("div", {
                          className: `${P(r, "sm")} sm:${P(r, "base")}`,
                          children: e.header.title_en,
                        }),
                      ],
                    }),
                  ],
              ...
              v.jsxs("div", {
                className:
                  "flex flex-col items-start sm:items-center w-full justify-between sm:flex-row",
                children: [
                  v.jsx("div", {
              ...
              `,
                    ...
                    children:
                      e.header.smartVaxCabinetEn === ""
                        ? v.jsx("div", {
                            className:
                              "bg-[linear-gradient(135deg,#EBD483,#CA9C59)] bg-clip-text text-transparent",
                            children: e.header.smartVaxCabinet,
                          })
                        : v.jsxs(v.Fragment, {
                            children: [
                              v.jsx("div", {
                              ...
                              v.jsx("div", {
                                className:
                                  "bg-[linear-gradient(135deg,#EBD483,#CA9C59)] bg-clip-text text-transparent text-sm",
                                children: e.header.smartVaxCabinetEn,
                              }),
                            ],
                          }),
                  }),
                  v.jsxs("div", {
                    className:
                      "flex sm:w-auto w-full justify-end gap-4 sm:gap-4 flex-shrink-0 pr-4",
                    children: [
                      v.jsx("button", {
                        className: `bg-[#006B93] text-white px-6 py-2 rounded ${P(
                          r,
                          "xs"
                        )} sm:${P(
                          r,
                          "sm"
                        )} hover:bg-[#005a85] font-bold shadow-[0px_3px_6px_rgba(0,0,0,0.35)] hover:shadow-[0px_4px_10px_rgba(0,0,0,0.45)] active:scale-95 transition-all`,
                        children: e.header.bookAppointment,
                      }),
                      v.jsx("button", {
                        onClick: () => n(t === "zh-TW" ? "en" : "zh-TW"),
                        className: `px-6 py-2 ${P(
                          r,
                          "sm"
                        )} bg-gray-100 rounded font-medium hover:bg-gray-200 font-bold shadow-[0px_3px_6px_rgba(0,0,0,0.35)] hover:shadow-[0px_4px_10px_rgba(0,0,0,0.45)] transition-all`,
                        style: { textShadow: "0 1px 2px rgba(0, 0, 0, 0.05)" },
                        children: e.header.languageSwitch,
                      }),
                    ],
                  }),
                ],
            ...
            children: [
              ...
              v.jsxs("div", {
                ...
                children: [
                  v.jsxs("div", {
                    className:
                      "flex gap-3 justify-center items-center relative left-[32px] z-10",
                    children: [
                      v.jsx("button", {
                        className: `bg-[#006B93] text-white px-6 py-2 rounded ${P(
                          r,
                          "sm"
                        )} font-bold shadow-[0px_3px_6px_rgba(0,0,0,0.35)] hover:shadow-[0px_4px_10px_rgba(0,0,0,0.45)] hover:bg-[#005a85] active:scale-95 transition-all`,
                        children: e.header.bookAppointment,
                      }),
                      v.jsx("button", {
                        onClick: () => n(t === "zh-TW" ? "en" : "zh-TW"),
                  ...
                  v.jsx("div", {
                    className:
                      "inline-block bg-transparent [filter:drop-shadow(1px_2px_2px_rgba(0,0,0,0.55))] transition-all",
                    children: v.jsx("div", {
  ...
  ap = ({ activeTab: e, onTabChange: t }) => {
    const { translations: n } = fn(),
      { fontSize: r, setFontSize: l } = Rt();
    return v.jsx("div", {
      className: "bg-white",
      children: v.jsx("div", {
        ...
        children: v.jsxs("div", {
          ...
          children: [
            v.jsxs("div", {
              className: "flex gap-2 sm:gap-4 mb-4 sm:mb-0",
              children: [
                v.jsx("div", {
                  className: `inline-block bg-transparent [filter:drop-shadow(2px_2px_4px_rgba(0,0,0,0.55))]
    hover:[filter:drop-shadow(4px_4px_8px_rgba(0,0,0,0.7))] transition-all`,
                  children: v.jsx("button", {
                    onClick: () => t("inventory"),
                    className: `relative py-2 px-4 sm:px-8 ${P(
                      r,
                      "base"
                    )} sm:${P(r, "lg")} lg:${P(
                      r,
                      "base"
                    )} whitespace-nowrap text-bold ${
                      e === "inventory"
                        ? "text-[#F4B400]"
                    ...
                    children:
                      e === "inventory"
                        ? v.jsx("div", {
                            className:
                              "bg-[linear-gradient(135deg,#EBD483,#CA9C59)] bg-clip-text text-bold text-transparent",
                            children: n.tabs.inventory,
                          })
                        : v.jsx("div", {
                            className:
                              "bg-[linear-gradient(135deg,#bbbbbb,#bbbbbb)] bg-clip-text text-bold text-transparent",
                            children: n.tabs.inventory,
                          }),
                  }),
                }),
    ...
    hover:[filter:drop-shadow(4px_4px_8px_rgba(0,0,0,0.7))] transition-all`,
                  children: v.jsx("button", {
                    onClick: () => t("search"),
                    className: `relative shadow-[0_6px_14px_rgba(0,0,0,0.6)] hover:shadow-[0_10px_24px_rgba(0,0,0,0.7)] py-2 px-4 sm:px-8 ${P(
                      r,
                      "base"
                    )} sm:${P(r, "lg")} lg:${P(
                      r,
                      "base"
                    )} text-bold transition-all whitespace-nowrap ${
                      e === "search"
                        ? "text-[#F4B400]"
                        : "text-[#333333] hover:text-[#666666]"
                    }`,
                    ...
                    children:
                      e === "search"
                        ? v.jsx("div", {
                            className:
                              "bg-[linear-gradient(135deg,#EBD483,#CA9C59)] bg-clip-text text-transparent",
                            children: n.tabs.search,
                          })
                        : v.jsx("div", {
                            className:
                              "bg-[linear-gradient(135deg,#bbbbbb,#bbbbbb)] bg-clip-text text-transparent",
                            children: n.tabs.search,
                          }),
                  }),
                }),
            ...
            v.jsx("div", {
              className:
                "flex items-center gap-1 sm:gap-2 w-full sm:w-auto sm:justifiy-center justify-end",
              children: v.jsx("div", {
                className: "flex gap-1 sm:gap-2",
                children: ["small", "medium", "large"].map((i) =>
                  v.jsx(
                    "button",
                    {
                      onClick: () => l(i),
                      className: `px-2 sm:px-3 py-1 rounded ${P(
                        r,
                        "xs"
      ...
      (
        ...
        $.createElement(
          "svg",
          {
            ...
            className: ["lucide", `lucide-${fp(e)}`, u].join(" "),
            ...c,
          },
          [
            ...t.map(([h, p]) => $.createElement(h, p)),
            ...(Array.isArray(s) ? s : [s]),
          ]
        )
    );
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */ const dp = oc("Check", [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]]);
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 ...
 */ const pp = oc("Search", [
  ...
  mp = ({ id: e, label: t, checked: n, onChange: r }) => {
    const { fontSize: l } = Rt();
    return v.jsxs("label", {
      className: "flex items-center gap-3 cursor-pointer py-1 sm:py-2",
      children: [
        v.jsx("div", {
          ...
          children:
            n && v.jsx(dp, { className: "w-3 h-3 sm:w-4 sm:h-4 text-white" }),
        }),
        v.jsx("span", {
          className: `${P(l, "base")} sm:${P(l, "lg")} text-[#333333]`,
          children: t,
        }),
        v.jsx("input", {
          type: "checkbox",
  ...
  vp = ({ onSearch: e }) => {
    const { translations: t } = fn(),
      { fontSize: n } = Rt(),
      [r, l] = $.useState([]),
      [i, o] = $.useState(""),
      u = (m, h) => {
        l((p) => (h ? [...p, m] : p.filter((x) => x !== m)));
      },
      s = () => {
        e == null || e({ selectedVaccineTypes: r, searchQuery: i });
      },
      c = (m) => {
        m.key === "Enter" && s();
      };
      ...
      children: [
          ...
          children: [
            v.jsxs("div", {
              ...
              children: [
                v.jsx(pp, {
                  className:
                    "absolute left-3 w-4 h-4 sm:w-5 sm:h-5 text-[#666666]",
                }),
                v.jsx("input", {
                  type: "text",
                  value: i,
                  ...
                  className: `w-full pl-10 pr-4 py-2 sm:py-3 border border-[#D4D4D4] rounded ${P(
                    n,
                    "sm"
                  )} sm:${P(
                    n,
                    "base"
                  )} placeholder-[#999999] focus:outline-none focus:ring-2 focus:ring-[#007AAF] focus:border-transparent`,
                }),
              ],
            }),
            v.jsx("button", {
              onClick: s,
              className: `w-full sm:w-auto bg-[#007AAF] text-white px-4 sm:px-6 py-2 sm:py-3 rounded ${P(
                n,
                "sm"
              )} sm:${P(
                n,
                "base"
              )} font-medium hover:bg-[#005a85] active:scale-95 transition-all`,
        ...
        v.jsxs("div", {
          ...
          children: [
            ...
            v.jsx("div", {
              className:
                "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1 sm:gap-1",
              children: hp.map((m) =>
                v.jsx(
                  mp,
                  {
                    id: m.id,
                    label: t.vaccines[m.labelKey] || m.id,
        ...
        v.jsx("div", {
          ...
          children: v.jsx("button", {
            onClick: s,
            className: `w-full sm:w-auto bg-[#007AAF] text-white px-8 sm:px-12 py-3 sm:py-4 rounded ${P(
              n,
              "sm"
            )} sm:${P(
              n,
            ...
            children: t.search.confirm,
          }),
        }),
      ],
    });
  },
  yp = { subsidized: "公費", selfPay: "自費", healthInsurance: "健保" },
  gp = ({ vaccines: e, typeFilter: t }) => {
    const { translations: n } = fn(),
      { fontSize: r } = Rt(),
      [l, i] = $.useState(null),
      o = t ? e.filter((u) => u.type === t) : e;
    return v.jsx("div", {
      className: "w-full overflow-x-auto border border-[#D4D4D4] rounded",
        ...
        children: [
          v.jsx("thead", {
            children: v.jsxs("tr", {
              ...
              children: [
                v.jsx("th", {
                  className: `px-4 sm:px-6 py-2 sm:py-3 text-left text-white ${P(
                    r,
                    "xs"
                  )} sm:${P(r, "sm")} font-semibold whitespace-nowrap`,
                  children: n.table.chineseName,
                }),
                v.jsx("th", {
                  className: `px-4 sm:px-6 py-2 sm:py-3 text-left text-white ${P(
                    r,
                ...
                v.jsx("th", {
                  ...
                  children: n.table.description,
                }),
                v.jsx("th", {
                  className: `px-4 sm:px-6 py-2 sm:py-3 text-center text-white ${P(
                    r,
                    "xs"
                  )} sm:${P(r, "sm")} font-semibold whitespace-nowrap`,
                  children: n.table.inventory,
                }),
              ],
            }),
          }),
            ...
            children:
              o.length === 0
                ? v.jsx("tr", {
                    children: v.jsx("td", {
                      colSpan: 5,
                      className: `px-4 sm:px-6 py-3 text-center text-[#666666] ${P(
                        r,
                        "sm"
                      )} sm:${P(r, "base")}`,
                      children: n.noData,
                ...
                : o.map((u, s) =>
                    v.jsxs(
                      "tr",
                      {
                        ...
                        children: [
                          v.jsx("td", {
                            className: `px-4 sm:px-6 py-2 sm:py-3 ${P(
                              r,
                              "xs"
                            )} sm:${P(r, "sm")} text-[#333333] font-medium`,
                            children: u.chineseName,
                          }),
                          v.jsx("td", {
                            className: `px-4 sm:px-6 py-2 sm:py-3 ${P(
                              r,
                              "xs"
                            )} sm:${P(r, "sm")} text-[#333333]`,
                            children: u.englishName,
                          }),
                          v.jsx("td", {
                            className: `px-4 sm:px-6 py-2 sm:py-3 ${P(
                              r,
                          ...
                          v.jsx("td", {
                            className: `px-4 sm:px-6 py-2 sm:py-3 ${P(
                              r,
                              "xs"
                            )} sm:${P(r, "sm")} text-[#666666]`,
                            children: u.description,
                          }),
                          v.jsx("td", {
                            className: "px-4 sm:px-6 py-2 sm:py-3 text-center",
                            children: v.jsx("span", {
                              className: `${P(r, "xs")} font-medium mt-1 ${
                                u.inventoryStatus === "adequate"
                                  ? "text-[#007AAF]"
                                  : u.inventoryStatus === "scarce"
                                  ? "text-[#FF8A00]"
                                  : "text-[#FF0000]"
                              }`,
                              children:
  ...
  xp = ({ vaccines: e, selectedFilter: t, onFilterChange: n }) => {
    const { translations: r } = fn(),
      { fontSize: l } = Rt();
    return v.jsxs("div", {
      className: "space-y-6",
      children: [
        v.jsx("div", {
          ...
          children: v.jsx("div", {
            ...
            children: ["subsidized", "selfPay", "healthInsurance"].map((i) =>
              v.jsx(
                "button",
                {
                  onClick: () => n(t === i ? null : i),
                  className: `px-4 sm:px-6 py-2 sm:py-3 rounded ${P(
                    l,
                    "xs"
                  )} sm:${P(l, "sm")} font-medium transition-all ${
                    t === i
                      ? "bg-[#007AAF] text-white hover:bg-[#005a85]"
                      : "bg-[#EFEFEF] text-[#333333] hover:bg-[#D4D4D4]"
                  }`,
                  children: r.filters[i],
                },
                i
              )
            ),
        ...
        v.jsx(gp, { vaccines: e, typeFilter: t }),
      ],
    });
  };
async function wp() {
  const e = await fetch("https://www.kutech.tw:4435/api/vaccine", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({}),
  });
  if (!e.ok) throw new Error("Failed to fetch vaccine data");
  const t = await e.json();
  return console.log(t), t;
}
function Sp(e) {
  const t = parseInt(e.Inventory) || 0;
  let n;
  t === 0 ? (n = "outOfStock") : t <= 3 ? (n = "scarce") : (n = "adequate");
  let r;
  const l = e.CustomText1.trim();
  return (
    l === "公費"
      ? (r = "subsidized")
      : l === "健保"
      ...
      : (r = "selfPay"),
    {
      id: e.GUID,
      chineseName: e.Name,
      englishName: e.Scientific_Name,
      type: r,
      description: e.ChineseName,
      inventory: t,
      inventoryStatus: n,
    }
  );
...
function kp() {
  const { fontSize: e } = Rt(),
    [t, n] = $.useState("inventory"),
    [r, l] = $.useState([]),
    [i, o] = $.useState([]),
    [u, s] = $.useState(null),
    [c, m] = $.useState(!0),
    [h, p] = $.useState({ selectedVaccineTypes: [], searchQuery: "" }),
    { translations: x, language: S, switchLanguage: k } = fn(),
    F = $.useRef(null),
    f = (y, w) => {
      const E = w.selectedVaccineTypes.length > 0,
        N = w.searchQuery.trim().length > 0;
      if (!E && !N) return y;
      const j = w.selectedVaccineTypes.map((O) => x.vaccines[O] || "");
      return y.filter((O) => {
        const L = !E || j.some((yt) => O.description.includes(yt)),
          ve =
            !N ||
            O.chineseName.toLowerCase().includes(w.searchQuery.toLowerCase()) ||
            O.englishName.toLowerCase().includes(w.searchQuery.toLowerCase());
        return L && ve;
      });
    },
    a = async (y = !1) => {
      try {
        y || m(!0);
        const E = (await wp()).Data.map(Sp);
        l(E);
        const N = f(E, h);
        o(N);
      } catch (w) {
        console.error("Failed to load vaccines:", w);
      } finally {
        y || m(!1);
      }
    };
  ...
  const d = ({ selectedVaccineTypes: y, searchQuery: w }) => {
    const E = { selectedVaccineTypes: y, searchQuery: w };
    p(E);
    const N = f(r, E);
    o(N), n("inventory");
  };
  return v.jsxs("div", {
    ...
    children: [
      v.jsx(sp, {}),
      v.jsx(ap, { activeTab: t, onTabChange: n }),
      v.jsxs("main", {
        className:
          "px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 lg:pt-8 pb-16 sm:pb-24 lg:pb-24 mx-auto",
        children: [
          c
            ? v.jsx("div", {
                className: "flex justify-center items-center py-12",
                children: v.jsx("div", {
                  className: `${P(e, "lg")} text-[#666666]`,
                  children: x.loading,
                }),
              })
            : t === "inventory"
            ? v.jsx(xp, { vaccines: i, selectedFilter: u, onFilterChange: s })
            : v.jsx(vp, { onSearch: d }),
          v.jsxs("div", {
            className:
              "w-full py-4 px-8 flex items-center justify-center gap-8",
            children: [
              v.jsx("div", { className: "flex-1 h-[1px] bg-gray-200" }),
              v.jsx("div", { children: x.note }),
              v.jsx("div", { className: "flex-1 h-[1px] bg-gray-200" }),
            ],
          }),
        ],
      ...
      v.jsxs("footer", {
        className:
          "justify-center items-center w-full fixed bottom-0 border-t border-[#D4D4D4] py-1 flex flex-col sm:flex-row sm:py-1 text-center text-xs sm:text-sm text-[#666666] bg-[#EFEFEF]",
        children: [
          v.jsx("span", { className: "pr-4", children: x.footer.hospital }),
          v.jsx("span", { children: x.footer.copyright }),
        ],
      }),
    ],
  });
...
function Ep() {
  return v.jsx(op, { children: v.jsx(lp, { children: v.jsx(kp, {}) }) });
}
rc(document.getElementById("root")).render(
  v.jsx($.StrictMode, { children: v.jsx(Ep, {}) })
);
